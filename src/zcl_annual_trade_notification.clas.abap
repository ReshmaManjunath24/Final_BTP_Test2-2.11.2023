...
*SELECT SINGLE * FROM ZDD_TRADE_VALIDITIY_RAP_FLAG WHERE  TradeNotification_Date = '20181201' INTO @ls_request.
 ...
 SELECT * FROM ZDD_TRADE_VALIDITIY_RAP_FLAG WHERE  zFLAG = 'X' INTO table  @lt_request.
...
** Email Instances and Template Creation
    TRY.
        ...
        iv_message = '<p>Dear Credit  Controller,</p> <p>the Trade License for customer A will be expired in 30 Days:</p><p> Reqeust_No: Request1 </p><p> Licence_ No: License1 </p> <p> Business Partner ID : BPID </p> <p> Valid to: Valid1 </p> <p><a ' &&
'href={Url}>Click here to view.</a></p> '.
