...
@EndUserText.label: 'Data Definition for CW Sales Area'
...
define view entity ZDD_CW_SALESAREA as select from 

  ztab_cw_salearea 
  
  association  to parent ZDD_CW_CUSTOMER as _zdd_clap on  $projection.zcustomer_num      = _zdd_clap.zcustomer_num
{
key zcustomer_num,
