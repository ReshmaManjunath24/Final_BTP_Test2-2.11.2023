...
@EndUserText.label: 'Data Definition for CW Basic Data'
define root view entity ZDD_CW_CUSTOMER as select from ztab_cw_custs
composition [1..*] of ZDD_CW_SALESAREA  as _zdd_sale
